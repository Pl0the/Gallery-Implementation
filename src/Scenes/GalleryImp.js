class GalleryImp extends Phaser.Scene {
    ...
    create() {
        ...
        my.sprite.alienBlue = this.add.sprite(game.config.width/2, game.config.height - 40, "alienBlue");
        ...
        document.getElementById('description').innerHTML = '<h2>Revenge of the Cute Animals</h2><br>A: left // D: right // Space: fire/emit // S: Next Scene'
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.space)) {
            ...
            if (my.sprite.bullet.length < this.maxBullets) {
                my.sprite.bullet.push(this.add.sprite(
                    my.sprite.alienBlue.x, my.sprite.alienBlue.y-(my.sprite.alienBlue.displayHeight/2), "snake")
                );
            }
        }
        ...
        // Check for collision with the moose
        for (let bullet of my.sprite.bullet) {
            if (this.collides(my.sprite.moose, bullet)) {
                // start animation
                this.puff = this.add.sprite(my.sprite.moose.x, my.sprite.moose.y, "whitePuff03").setScale(0.25).play("puff");
                // clear out bullet -- put y offscreen, will get reaped next update
                bullet.y = -100;
                my.sprite.moose.visible = false;
                my.sprite.moose.x = -100;
                // Update score
                this.myScore += my.sprite.moose.scorePoints;
                this.updateScore();
                // Play sound
                this.sound.play("dadada", {
                    volume: 1   // Can adjust volume using this, goes from 0 to 1
                });
                // Have new moose appear after end of animation
                this.puff.on(Phaser.Animations.Events.ANIMATION_COMPLETE, () => {
                    this.my.sprite.moose.visible = true;
                    this.my.sprite.moose.x = Math.random()*config.width;
                }, this);
